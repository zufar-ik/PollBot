...
class Poll_class(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = 'Сборники вопросов 1'
...
class Poll(models.Model):
    ...
    open_period = models.IntegerField(default=10, verbose_name='Время завершения теста',
    ...
    class Meta:
        ...
        verbose_name_plural = 'Вопросы сборников 2'
...
class Poll_answer(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = 'Варианты Ответов 3'
